// apps/mobile/app/_layout.tsx — root: fonts + providers + api config + session bootstrap + route guard
...
export default function RootLayout() {
  ...
  // Single routing authority — replaces the old competing <Redirect> components.
