  ...
  return (
    <Screen>
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <ListRow icon="person-outline" title="Personal details" />
        <ListRow icon="card-outline" title="Payment methods" />
        <ListRow icon="settings-outline" title="Settings" />

        <SectionLabel>SUPPORT</SectionLabel>
        <ListRow icon="help-circle-outline" title="Support" />

        <SectionLabel>ABOUT</SectionLabel>
        <ListRow icon="information-circle-outline" title="About Social Remit" />
        <ListRow icon="document-text-outline" title="Legal information" />

        <Pressable onPress={() => void signOut()} className="mt-8 mb-4 items-center">
